...
/*$(".filter__list li").on('click', function(){
    ...
    if(filter == 'f_2'){
      $(".project-slider").slick('slickFilter','.f_2');
    }
    else if(filter == 'f_3'){
      $(".project-slider").slick('slickFilter','.f_3');
    }
    else if(filter == 'f_4'){
      $(".project-slider").slick('slickFilter','.f_4');
    }
    else if(filter == 'f_5'){
      $(".project-slider").slick('slickFilter','.f_5');
    }
    else if(filter == 'f_6'){
      $(".project-slider").slick('slickFilter','.f_6');
    }
    else if(filter == 'f_1'){
...
/*	$('.filter__item').on('click', function(event) {
		let attribute = $(this).data('filter');
		$('.project-slider').slick('slickUnfilter');
		if (attribute == 'f_1') {
			return;
		}
		$('.project-slider').slick('slickFilter', function() {
			return $('.project__item' + '.' + attribute, this).length === 1;
		});
	});
};*/
...
jQuery(document).ready(function($) {
    $('.project-slider').slickFilterable({
